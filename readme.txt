...
Добавила:
1. Синхронизацию корзины с LS (с проверкой на наличие и формат, поэтому отдельной функцией)
> запись в LS корзины (store.js -> store.subscribe)
> чтение из LS в корзину в state (initialState.js -> getInitialState)
2. Подсветку кнопки "В корзину" при наведении. 
...
Информация по выбранным для заказа товарам пишется справа внизу, "Выбрано для заказа".
И при добалении в корзину на странице товаров есть нюанс: если ввести количество, добавить, потом перейти на другую страницу и вернуться, то количество у положенных в корзину товаров будет снова 0. В корзине они будут. Будет пофикшено в ДЗ4. 
Ну и корзина пока в LS не сохраняется, но об этом в задании ни слова)
